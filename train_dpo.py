...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MeuAI RLHF")
    ...
    parser.add_argument("--wandb_project", type=str, default="MeuAI-RLHF-SFT")
    ...
    args.wandb_run_name = f"MeuAI-Full-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
